...
var row2 = new Row2();
var row3 = new Row3();
var column1 = new Column1();
var column2 = new Column2();
var column3 = new Column3();
var diagonalLine1 = new DiagonalLine1();
var diagonalLine2 = new DiagonalLine2();
var initMat = 1;
var playerInput;
var validationCount = 0;
var NumBlockLocation;
var NumAttackLocation;
var countVictory;
var matrix;
matrix = new Array(3);
...
function playGame() {
    ...
    else if ((NumBlockLocation != "0") && (NumAttackLocation == "0")) {
...
function insertPlayerInput(input) {
    switch (Number(input)) {
        case 1:
...
function insertCompInput(input) {
    switch (Number(input)) {
        case 1:
